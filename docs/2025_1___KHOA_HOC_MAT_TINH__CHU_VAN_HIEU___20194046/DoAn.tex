...
% \setcounter{tocdepth}{3} % Chèn subsubsection vào bảnục
...
\sloppy % URL xuống dòng mềm hơn
\renewcommand{\bibname}{TÀI LIỆU THAM KHẢO}
\markboth{TÀI LIỆU THAM KHẢO}{TÀI LIỆU THAM KHẢO}
\begin{thebibliography}{99}
	
	\bibitem{ref_itviec}
	\textit{ITviec}. [Online]. Available: \url{https://itviec.com/}.
	
	\bibitem{ref_topcv}
	\textit{TopCV}. [Online]. Available: \url{https://www.topcv.vn/viec-lam}.
	
	\bibitem{ref_design_pattern}
	\textit{Design pattern là gì?} [Online]. Available: \url{https://topdev.vn/blog/design-pattern-la-gi/}.
	
	\bibitem{ref_react}
	\textit{ReactJS là gì?} [Online]. Available: \url{https://200lab.io/blog/reactjs-la-gi}.
	
	\bibitem{ref_typescript}
	\textit{TypeScript là gì?} [Online]. Available: \url{https://topdev.vn/blog/typescript-la-gi/}.
	
	\bibitem{ref_ts_vs_js}
	\textit{So sánh TypeScript với JavaScript.} [Online]. Available: \url{https://topdev.vn/blog/so-sanh-typescript-voi-javascript/}.
	
	\bibitem{ref_tailwind}
	\textit{Tailwind CSS.} [Online]. Available: \url{https://www.careerlink.vn/cam-nang-viec-lam/tu-van-nghe-nghiep/tailwind-css}.
	
	\bibitem{ref_nodejs}
	\textit{NodeJS.} [Online]. Available: \url{https://www.careerlink.vn/cam-nang-viec-lam/tu-van-nghe-nghiep/tailwind-css}.
	
	\bibitem{ref_cbf}
	\textit{Tìm hiểu về Content-based Filtering -- Phần 1.} [Online]. Available: \url{https://viblo.asia/p/tim-hieu-ve-content-based-filtering-phuong-phap-goi-y-dua-theo-noi-dung-phan-1-V3m5WGBg5O7}.
	
	\bibitem{ref_layered_arch}
	\textit{Layered Architecture.} [Online]. Available: \url{https://lorifpeterson.com/?p=24}.
